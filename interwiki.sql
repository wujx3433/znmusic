...
('google','https://www.google.com/search?q=$1',1,''),
...
('imdb','http://www.imdb.com/find?q=$1&tt=on',1,''),
...
('mediawikiwiki','https://www.mediawiki.org/wiki/$1',1,'https://www.mediawiki.org/w/api.php'),
...
('mw','https://www.mediawiki.org/wiki/$1',1,'https://www.mediawiki.org/w/api.php'),
...
('wikimedia','https://foundation.wikimedia.org/wiki/$1',1,'https://foundation.wikimedia.org/w/api.php'),
('wikinews','https://en.wikinews.org/wiki/$1',1,'https://en.wikinews.org/w/api.php'),
('wikipedia','https://en.wikipedia.org/wiki/$1',1,'https://en.wikipedia.org/w/api.php'),
('wikiquote','https://en.wikiquote.org/wiki/$1',1,'https://en.wikiquote.org/w/api.php'),
...
('wiktionary','https://en.wiktionary.org/wiki/$1',1,'https://en.wiktionary.org/w/api.php'),
('zhmoe', 'https://zh.moegirl.org/$1', 1, 0),
('zhwiki', 'https://zh.wikipedia.org/wiki/$1', 1, 0),
('萌百',' https://zh.moegirl.org/$1', 1, 0),
('hmoe',' https://hmoegirl.com/$1', 1, 0),
('moegirl',' https://zh.moegirl.org/$1', 1, 0),
('enwiki',' https://en.wikipedia.org/wiki/$1', 1, 0),
('jawiki',' https://ja.wikipedia.org/wiki/$1', 1, 0),
('bing','https://www.bing.com/search?q=$1',1,0),
('bili','http://www.bilibili.tv/search?keyword=$1',1,0),
('acfun','https://www.acfun.cn/search/?type=complex&keyword=$1',1,0),
('music163','https://music.163.com/#/search/m/?s=$1',1,0);
