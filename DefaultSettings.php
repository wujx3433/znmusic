 ...
 */
 # 下面这行是决定你的wiki能上传什么文件的，当然，你如果安装了别的媒体处理器的话，无需编辑下列参数即可上传相应媒体文件
$wgFileExtensions = [ 'png', 'gif', 'jpg', 'jpeg', 'svg', 'webp', 'wav', 'mp3', 'ogg', 'mp4', 'pdf', 'gp5', 'gpx', 'mp4', 'mscz', 'sib' ];
